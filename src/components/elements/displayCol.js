            ...
            <div className="flex flex-grow flex-col">
                ...
                }
                {
                    ...
                    <form className="relative my-1 flex items-center justify-start">
                        <input className="flex-grow rounded-lg border border-zinc-700 bg-transparent px-3 py-2.5 pb-12 text-sm text-zinc-200 placeholder:text-zinc-600 focus:outline-none" placeholder="Type and press enter to save or esc to cancel" />
                        <div className="absolute bottom-3 left-3.5 right-3.5 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <button type="submit" className="group flex items-center gap-1 rounded-md text-xs uppercase tracking-wide text-zinc-500 hover:text-zinc-300">
                ...
                {/* <div className="absolute inset-x-0 bottom-0 -mb-3.5 flex flex-grow items-end justify-center rounded-b-md bg-gradient-to-t from-zinc-900 to-zinc-900 py-3.5">
            <button className="z-[10] flex cursor-pointer items-center gap-2 rounded-md border-dashed border-zinc-700 text-sm text-zinc-500 transition-colors hover:border-zinc-500 hover:text-zinc-200">
                ...
                </svg>Show 1 completed task</button>
        </div> */}
            </div>
        </div>
    </>;
