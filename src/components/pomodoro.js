    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen w-2/5 m-auto">
            <div className="flex space-x-4 mb-4">
                ...
                <button onClick={() => handleChangeMode('short', 300)} className="flex items-center justify-center rounded-md px-3 py-3 transition-colors sm:py-1.5 bg-transparent text-zinc-700 hover:bg-zinc-800 hover:text-zinc-400">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="block h-4 w-4 sm:hidden">
                ...
                <button onClick={() => handleChangeMode('long', 900)} className="flex items-center justify-center rounded-md px-3 py-3 transition-colors sm:py-1.5 bg-transparent text-zinc-700 hover:bg-zinc-800 hover:text-zinc-400">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="block h-4 w-4 sm:hidden">
            ...
            <div className='mt-5 flex items-center gap-1.5 sm:gap-3'>
                {isActive ? (
                    <>
                        <button onClick={() => setIsPaused((prev) => !prev)} className="flex items-center justify-center bg-zinc-800 px-3 text-zinc-400 transition-colors hover:bg-zinc-700 hover:text-zinc-200 sm:py-1.5 rounded-lg py-2">
                            {isPaused ?
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="block h-4 w-4 sm:hidden">
                        ...
                        <button onClick={handleStop} className="flex items-center justify-center bg-zinc-800 px-3 text-zinc-400 transition-colors hover:bg-zinc-700 hover:text-zinc-200 sm:py-1.5 rounded-lg py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="block h-4 w-4 sm:hidden">
                    ...
                    <button onClick={() => setIsActive(true)} className="flex items-center justify-center bg-zinc-800 px-3 text-zinc-400 transition-colors hover:bg-zinc-700 hover:text-zinc-200 sm:py-1.5 rounded-lg py-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="block h-4 w-4 sm:hidden">
                            <polygon points="6 3 20 12 6 21 6 3"></polygon>
                        </svg>
